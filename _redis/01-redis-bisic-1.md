...
```bash
redis> setbit k 1 1 #设置第1位的值 0/1, k 为 键名称
(integer) 0
redis> setbit k 4 1 #设置第4位的值 0/1
(integer) 0
redis> getbit k 1  # 获取某个具体位置的值 0/1
(integer) 1
redis> getbit k 4
(integer) 1
redis> getbit k 5
...
```bash
redis> set mykeys h    # 整存 h为 1101000
"OK"
redis> getbit mykeys 1
(integer) 1
redis> getbit mykeys 2
(integer) 1
redis> getbit mykeys 3
(integer) 0
redis> getbit mykeys 4
(integer) 1
```
